...
#ifdef _DEBUG
	#undef _DEBUG
	#include "../../Extern/Python27/Python.h"
	#define _DEBUG
#else
	#include "../../Extern/Python27/Python.h"
#endif
#include "../../Extern/Python27/node.h"
#include "../../Extern/Python27/grammar.h"
#include "../../Extern/Python27/token.h"
#include "../../Extern/Python27/parsetok.h"
#include "../../Extern/Python27/errcode.h"
#include "../../Extern/Python27/compile.h"
#include "../../Extern/Python27/symtable.h"
#include "../../Extern/Python27/eval.h"
#include "../../Extern/Python27/marshal.h"
